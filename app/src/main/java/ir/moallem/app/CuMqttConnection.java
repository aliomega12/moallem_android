...
public class CuMqttConnection {
   ...
   */
  public static CuMqttConnection createConnection(String clientId, String host,
    ...
    return new CuMqttConnection(handle, clientId, host, port, context, client, sslConnection);
   ...
   * @param sslConnection true if the connection is secured by SSL
   */
  public CuMqttConnection(String clientHandle, String clientId, String host,
  ...
  public boolean equals(Object o) {
    if (!(o instanceof CuMqttConnection)) {
      return false;
    }

    CuMqttConnection c = (CuMqttConnection) o;
